...
public class NWT_TestPublisher {
    ...
    public static void main(String[] args) {
        ...
        //int targetByteLength = 10000;

        //while (stringBuilder.toString().getBytes().length < targetByteLength) {
        //      stringBuilder.append("A");
        //}
        //String bytes = stringBuilder.toString();
        //System.out.println("String length: " + bytes.length());
        //System.out.println("String iBytes: " + bytes.getBytes().length);
        ...
        System.out.println("Latency : " + (latency / 100) / 2);
    }
}