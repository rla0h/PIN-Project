 ...
 */
 ...
 public class PinPublisher {
   ...
   public static void main(String[] args) throws Exception
   {
     ...
     Topic topa = dp.create_topic("ACDCTerminal",
                                 servant.get_type_name(),
                                 TOPIC_QOS_DEFAULT.get(),
                                 null,
                                 DEFAULT_STATUS_MASK.value);
     Topic topb = dp.create_topic("ACLineSegment",
                                 servant.get_type_name(),
                                 TOPIC_QOS_DEFAULT.get(),
                                 null,
                                 DEFAULT_STATUS_MASK.value);
     ...
     // Generate JSON
     String fileDir = "PinJson2.json";
 
     String json_str = new String(Files.readAllBytes(Paths.get("PinJson2.json")), Charset.defaultCharset());
     JSONObject json = new JSONObject(json_str);
     JSONObject io = json.getJSONObject(topa.get_name());
     String io_str = io.toString();
     JSONObject acl = json.getJSONObject(topb.get_name());
     String l_str = acl.toString();
