...
*/
public class RecloserTopicSubscriber extends Application implements AutoCloseable {

    private DomainParticipant participant = null; // Usually one per application
    private RecloserTopicDataReader reader = null;
    private final RecloserTopicSeq dataSeq = new RecloserTopicSeq();
    ...
    private void runApplication() {
        ...
        // This DataReader reads data on "Example RecloserTopic" Topic
        reader = (RecloserTopicDataReader) Objects.requireNonNull(
    ...
    public static void main(String[] args) {
        ...
        try (RecloserTopicSubscriber subscriberApplication = new RecloserTopicSubscriber()) {
